...
# main smetrics __init__ can detect if it is being loaded by the setup
# routine, to avoid attempting to load components that aren't built yet:
# the numpy distutils extensions that are used by smetrics to
# recursively build the compiled extensions in sub-packages is based on the
# Python import machinery.
builtins.__smetrics_SETUP__ = True
...
URL = 'https://github.com/sylvainprigent/smetrics'
DOWNLOAD_URL = 'https://github.com/sylvainprigent/smetrics'
LICENSE = 'GPL-3.0'
PROJECT_URLS = {
    'Bug Tracker': 'https://github.com/sylvainprigent/smetrics/issues',
    'Documentation': 'https://github.com/sylvainprigent/smetrics',
    'Source Code': 'https://github.com/sylvainprigent/smetrics'
}

# We can actually import a restricted version of smetrics that
# does not need the compiled code
import smetrics
import smetrics._build_utils.min_dependencies as min_deps  # noqa


VERSION = smetrics.__version__
...
class CleanCommand(Clean):
    ...
    def run(self):
        ...
        if os.path.exists('build'):
            shutil.rmtree('build')
        for dirpath, dirnames, filenames in os.walk('smetrics'):
...
try:
    ...
    class build_ext_subclass(build_ext):
        def build_extensions(self):
            from smetrics._build_utils.openmp_helpers import get_openmp_flag

            if smetrics._OPENMP_SUPPORTED:
...
# To automate release of binary packages for smetrics we need a tool
...
def configuration(parent_package='', top_path=None):
    ...
    from smetrics._build_utils import _check_cython_version
    ...
    config.add_subpackage('smetrics')
...
def check_package_status(package, min_version):
    ...
    req_str = "smetrics requires {} >= {}.\n".format(
        package, min_version)

    instructions = ("Installation instructions are available on the "
                    "smetrics website: "
                    "http://smetrics.org/stable/install.html\n")
...
def setup_package():
    ...
    if len(sys.argv) == 1 or (
        ...
        # pip is used to install smetrics when Numpy is not yet present in
        # the system.
        ...
        if sys.version_info < (3, 7):
            raise RuntimeError(
                "smetrics requires Python 3.7 or later. The current"
